...
function TripLoadingAnimation({ animationPath }: { animationPath: string }) {
  ...
  return (
    <div
      className={`mx-auto flex h-56 w-56 items-center justify-center transition-all duration-300 ease-out sm:h-60 sm:w-60 ${
        isChanging
...
{isLongTrip
            ? "Long trips are generated in several sections. Please keep this page open while we finish the complete itinerary."
            : "Please keep this page open while we generate your selected itinerary, alternative options, and budget estimate."}
        </p>
      </div>
    </div>
  );
