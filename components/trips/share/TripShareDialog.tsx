...
import { Check, Copy, Link2, Mail, Share2, Unlink, X } from "lucide-react";
...
export default function TripShareDialog({
  ...
  function renderTrigger() {
    ...
    return (
      <button
        ...
        aria-label={
          triggerVariant === "icon" ? `Share ${tripTitle}` : undefined
        }
  ...
  async function handleNativeShare() {
    ...
    try {
      ...
      setError(
        "The share sheet could not be opened. Please try another option.",
      );
    }
  }
  ...
  return (
    <>
      ...
      {isOpen && portalTarget
        ? createPortal(
            <div
              className="fixed inset-0 z-9999 flex items-end justify-center p-3 backdrop-blur-sm sm:items-center"
              role="dialog"
              aria-modal="true"
                    ...
                    <div className="space-y-5">
                      <div>
                        ...
                        <div className="mt-2 flex flex-wrap items-center justify-between gap-2 text-xs leading-5 text-secondary-foreground">
                          <p>
                            Anyone with this link can view, but cannot edit.
                          </p>
