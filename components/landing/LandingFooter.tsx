        ...
        <footer className="bg-white px-4 pt-20 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <div className="flex flex-col items-center">
                    ...
                    <div className="h-28 w-full overflow-hidden sm:h-40 lg:h-52">
                        <h2 className="select-none translate-y-4 text-center text-[4.5rem] font-black leading-none tracking-[-0.09em] text-[#5b351a]/40 sm:translate-y-6 sm:text-[8rem] lg:translate-y-8 lg:text-[12rem]">
                            Kartografer
                        </h2>
                    </div>
                </div>
