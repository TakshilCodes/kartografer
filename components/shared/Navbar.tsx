  ...
  return (
    <header className="fixed left-0 top-5 z-50 w-full px-4">
      <div className="mx-auto w-full max-w-6xl">
        <nav className="relative flex h-[72px] items-center justify-between overflow-hidden rounded-[2rem] border border-white/45 bg-white/25 px-3 text-foreground shadow-[0_24px_80px_rgba(93,62,29,0.16)] backdrop-blur-2xl sm:px-4">
          {/* Glass layers */}
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute inset-0 bg-gradient-to-b from-white/45 via-white/20 to-white/10" />
            <div className="absolute inset-0 bg-card/25" />
            <div className="absolute left-0 top-0 h-full w-1/3 bg-gradient-to-r from-card-secondary/40 to-transparent" />
            <div className="absolute right-0 top-0 h-full w-1/3 bg-gradient-to-l from-card-secondary/30 to-transparent" />
            <div className="absolute left-1/2 top-[-90px] h-36 w-80 -translate-x-1/2 rounded-full bg-accent/20 blur-3xl" />
