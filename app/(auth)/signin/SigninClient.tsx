...
export default function SigninClient() {
    ...
    startCredentialsTransition(async () => {
      ...
      if (result?.error) {
        if (result.error.startsWith("LOGIN_RATE_LIMITED:")) {
          const retryAfterSeconds = Number(result.error.split(":")[1]);
  ...
  const isLoading = isCredentialsPending || isGooglePending;
        ...
        <div className="w-full max-w-110">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="mt-2 text-sm font-semibold text-muted-foreground">
              Sign in to open your travel workspace.
            </p>
          </div>
                ...
                <div>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="cursor-pointer text-xs font-black text-secondary-foreground transition hover:text-primary-hover hover:underline"
                    >
                      Forgot?
                    </Link>
                  </div>
