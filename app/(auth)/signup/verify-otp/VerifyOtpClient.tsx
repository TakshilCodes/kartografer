...
export default function VerifyOtpClient({ email }: VerifyOtpClientProps) {
  ...
  function handleResendOtp() {
    ...
    startResendTransition(async () => {
      /**
       * IMPORTANT:
       * Your sendSignupOtpAction currently requires name + password too.
       * That means you cannot safely resend OTP from this page unless:
       *
       * Option A: create a separate resendSignupOtpAction(email)
       * Option B: store pending signup in Redis and resend using that data
       *
       * For now, redirect user back to signup.
       */
      router.push("/signup");
    });
  }
